    ...
    execute: function () {
      ...
      _export("GameData", GameData = class GameData {
        ...
        async getGameConfig() {
          ...
          const config = await (_crd && GameUtils === void 0 ? (_reportPossibleCrUseOfGameUtils({
            error: Error()
        ...
        getCurrentCardPrice(playType) {
          ...
          let curPrice = (_this$gameList$find = this.gameList.find(game => game.playType === playType)) == null ? void 0 : _this$gameList$find.unitPrice;
